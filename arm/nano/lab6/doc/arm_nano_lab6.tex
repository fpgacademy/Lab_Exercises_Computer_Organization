...
When the clock reaches \blue{59}:\blue{59}:\blue{99} it should wrap around 
...
message were \blue{\sf DE10-Nano}, then Table 1 shows what the Terminal window would 
...
\begin{center}
		  Table 1. Scrolling the message \blue{\sf DE10-Nano} on the Terminal window.
\end{center}
\end{minipage}
\end{center}
