...
the connection between the DE0-Nano-SoC board and the host computer. This is the name assigned to the 
USB-Blaster connection between the computer and the DE0-Nano-SoC board.
...
the location {\it Digits}. For the value $N = 76$ ({\sf 0x4c}) shown in the figure, the code sets {\it Digits} to {\sf 00000706}.
